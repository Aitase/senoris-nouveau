...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="hero-wrapper" id="accueil">
        ...
        <nav className="nav-glass">
          <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ fontSize: '1.8rem', fontWeight: 900, letterSpacing: '2px', color: 'var(--bg-cream)' }}>
              SENORIS<span style={{ color: 'var(--accent-gold)' }}>.</span>
            </div>
            {/* Desktop Nav */}
            <div className="desktop-nav" style={{ display: 'flex', gap: '40px', alignItems: 'center', fontWeight: '600' }}>
              <a href="#about" style={{ color: 'var(--bg-cream)', textDecoration: 'none' }}>Mission</a>
              <a href="#services" style={{ color: 'var(--bg-cream)', textDecoration: 'none' }}>Expertise</a>
              <a href="#projets" style={{ color: 'var(--bg-cream)', textDecoration: 'none' }}>Réalisations</a>
              <a href="#equipe" style={{ color: 'var(--bg-cream)', textDecoration: 'none' }}>Équipe</a>
        ...
        <div className="container" style={{ paddingTop: '160px', paddingBottom: '160px', display: 'flex', alignItems: 'center', gap: '6%', flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: '1 1 480px', minWidth: '300px' }} className="reveal">
            ...
            {/* Badge pill */}
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', padding: '8px 22px', background: 'rgba(253,250,247,0.1)', border: '1px solid rgba(253,250,247,0.2)', borderRadius: '100px', marginBottom: '36px' }}>
              <span style={{ width: 8, height: 8, borderRadius: '50%', background: 'var(--accent-gold)', display: 'inline-block', boxShadow: '0 0 8px var(--accent-gold)' }}></span>
              <span style={{ color: 'var(--bg-cream)', fontSize: '0.82rem', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '1.5px' }}>Agence Tech Premium au Sénégal</span>
            </div>

            <h1 className="hero-title">
              Excellence <br />
              <span className="text-gradient">Technologique</span> &amp; <br />
              <span style={{ color: 'var(--accent-gold)' }}>Cybersécurité.</span>
            </h1>
        ...
        <div className="container">
          ...
          <div className="reveal">
            <div style={{
              ...
              <div style={{ flex: '1 1 300px', background: 'var(--accent-main)', position: 'relative', overflow: 'hidden', minHeight: '300px' }}>
                <div style={{
                  position: 'absolute',
                  top: '20%',
                  left: '20%',
                  ...
                  <div style={{ width: '40px', height: '8px', background: 'var(--accent-main)', borderRadius: '10px', marginBottom: '20px' }}></div>
                  <div style={{ height: '30px', width: '200px', background: 'var(--bg-nude-border)', borderRadius: '4px', marginBottom: '15px' }}></div>
                  <div style={{ height: '150px', width: '100%', background: 'var(--bg-white)', borderRadius: '4px', border: '1px solid var(--bg-nude-border)' }}></div>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* --- ABOUT / MISSION --- */}
      <section id="about" className="section-padding" style={{ background: 'var(--bg-global)' }}>
        <div className="container">
          <div style={{ display: 'flex', gap: '60px', alignItems: 'center', flexWrap: 'wrap' }}>
            <div className="reveal" style={{ flex: '1 1 500px' }}>
              <h4 style={{ fontSize: '0.9rem', color: 'var(--accent-gold)', marginBottom: '16px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '2px' }}>SENORIS, votre allié technologique</h4>
              <h2 style={{ fontSize: '3rem', fontWeight: 900, lineHeight: 1.1, color: 'var(--text-primary)', marginBottom: '30px' }}>
                Passionnés par l'innovation et la cybersécurité.
              </h2>
              <p style={{ fontSize: '1.1rem', opacity: 0.8, lineHeight: '1.8', color: 'var(--text-secondary)' }}>
            ...
            <div className="reveal reveal-delay-1" style={{ flex: '1 1 450px' }}>
              <div style={{ background: '#FFF', padding: '40px', borderRadius: '32px', boxShadow: '0 20px 40px rgba(0,0,0,0.02)' }}>
                <h4 style={{ fontSize: '1.3rem', color: 'var(--accent-main)', marginBottom: '12px', fontWeight: 700 }}>Notre Mission</h4>
                <p style={{ marginBottom: '24px', opacity: 0.8, fontSize: '0.95rem', color: 'var(--text-secondary)' }}>Offrir des services technologiques premium avec une exigence constante de qualité.</p>
                <h4 style={{ fontSize: '1.3rem', color: 'var(--accent-main)', marginBottom: '12px', fontWeight: 700 }}>Notre Vision</h4>
                <p style={{ opacity: 0.8, fontSize: '0.95rem', color: 'var(--text-secondary)' }}>Construire un écosystème numérique plus sûr en Afrique.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* --- FOOTER --- */}
      <footer style={{ background: 'linear-gradient(to bottom, var(--footer-base), var(--footer-dark))', color: 'var(--bg-cream-alt)', padding: '60px 0 40px' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '40px', marginBottom: '50px' }}>

            {/* Brand */}
            <div className="reveal">
              <div style={{ fontSize: '1.6rem', fontWeight: 900, letterSpacing: '2px', marginBottom: '16px' }}>
                SENORIS<span style={{ color: 'var(--accent-gold)' }}>.</span>
              </div>
            ...
            <div className="reveal reveal-delay-1">
              <h4 style={{ fontSize: '1rem', fontWeight: 800, marginBottom: '20px', color: 'var(--accent-gold)' }}>Navigation</h4>
              <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '0.85rem' }}>
                <li><a href="#accueil" style={{ color: 'inherit', textDecoration: 'none', opacity: 0.7, transition: 'opacity 0.2s' }} onMouseEnter={e => (e.currentTarget as HTMLElement).style.opacity = '1'} onMouseLeave={e => (e.currentTarget as HTMLElement).style.opacity = '0.7'}>Accueil</a></li>
                <li><a href="#services" style={{ color: 'inherit', textDecoration: 'none', opacity: 0.7, transition: 'opacity 0.2s' }} onMouseEnter={e => (e.currentTarget as HTMLElement).style.opacity = '1'} onMouseLeave={e => (e.currentTarget as HTMLElement).style.opacity = '0.7'}>Expertise</a></li>
                <li><a href="#projets" style={{ color: 'inherit', textDecoration: 'none', opacity: 0.7, transition: 'opacity 0.2s' }} onMouseEnter={e => (e.currentTarget as HTMLElement).style.opacity = '1'} onMouseLeave={e => (e.currentTarget as HTMLElement).style.opacity = '0.7'}>Réalisations</a></li>
                <li><a href="#equipe" style={{ color: 'inherit', textDecoration: 'none', opacity: 0.7, transition: 'opacity 0.2s' }} onMouseEnter={e => (e.currentTarget as HTMLElement).style.opacity = '1'} onMouseLeave={e => (e.currentTarget as HTMLElement).style.opacity = '0.7'}>Équipe</a></li>
                <li><a href="#contact" style={{ color: 'inherit', textDecoration: 'none', opacity: 0.7, transition: 'opacity 0.2s' }} onMouseEnter={e => (e.currentTarget as HTMLElement).style.opacity = '1'} onMouseLeave={e => (e.currentTarget as HTMLElement).style.opacity = '0.7'}>Contact</a></li>
              </ul>
            </div>
            ...
            <div className="reveal reveal-delay-2">
              <h4 style={{ fontSize: '1rem', fontWeight: 800, marginBottom: '20px', color: 'var(--accent-gold)' }}>Réseaux</h4>
              <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                {[{ href: 'https://www.linkedin.com/company/senoris', bg: '#0077B5', d: 'M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z', label: 'LinkedIn' },
                { href: 'https://www.instagram.com/senoris2026', bg: 'linear-gradient(45deg,#f09433,#e6683c,#dc2743,#cc2366,#bc1888)', d: 'M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z', label: 'Instagram' },
                { href: 'https://www.tiktok.com/@senoris2026', bg: '#010101', d: 'M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.17-2.89-.6-4.13-1.47-.13-.09-.26-.18-.38-.28.01 4.38-.02 8.76.01 13.14-.03 1.1-.24 2.23-.74 3.24-1.01 2.15-3.19 3.65-5.54 3.89-2.58.27-5.23-.77-6.84-2.83-1.61-2.07-2-4.9-1.01-7.27.95-2.27 3.12-3.87 5.58-4.12.35-.04.7.01 1.05.04v4.03c-.63.07-1.27.24-1.84.55-.95.53-1.57 1.48-1.66 2.56-.09 1.15.5 2.3 1.47 2.89.97.59 2.24.59 3.21 0 .97-.59 1.56-1.74 1.47-2.89V0h.01Z', label: 'TikTok' },
                { href: 'https://www.facebook.com/share/1THZQkQK6q/', bg: '#1877F2', d: 'M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z', label: 'Facebook' },
                ].map(({ href, bg, d, label }) => (
                  <a key={label} href={href} title={label} target="_blank" rel="noreferrer"
                    style={{ width: 38, height: 38, borderRadius: '10px', background: bg, display: 'flex', alignItems: 'center', justifyContent: 'center', transition: 'transform 0.2s, opacity 0.2s', opacity: 0.85 }}
                    onMouseEnter={e => { (e.currentTarget as HTMLElement).style.transform = 'translateY(-3px)'; (e.currentTarget as HTMLElement).style.opacity = '1'; }}
                    onMouseLeave={e => { (e.currentTarget as HTMLElement).style.transform = 'translateY(0)'; (e.currentTarget as HTMLElement).style.opacity = '0.85'; }}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="#ffffff"><path d={d} /></svg>
                  </a>
                ))}
              </div>
            </div>
