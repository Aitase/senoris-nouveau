                ...
                <div className="reveal reveal-delay-2 glass-card-nude" style={{ padding: '24px', display: 'flex', gap: '20px', alignItems: 'center', transform: 'none' }}>
                   ...
                   <div>
                      ...
                      <div style={{ display: 'flex', gap: '10px' }}>
                          ...
                          <a href="#" className="social-link" style={{ width: 36, height: 36 }} title="Instagram">
                          ...
                          <a href="#" className="social-link" style={{ width: 36, height: 36 }} title="LinkedIn">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '40px', marginBottom: '40px' }}>
            ...
            <div className="reveal">
              ...
              <p style={{ opacity: 0.6, fontSize: '0.8rem', lineHeight: '1.8' }}>
                Spécialistes de la transformation digitale et de la cybersécurité.
              </p>
            </div>
            ...
            <div className="reveal reveal-delay-2">
              ...
              <ul style={{ listStyle: 'none', padding: 0, display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '0.85rem' }}>
                 <li><a href="#" style={{ color: 'inherit', textDecoration: 'none', opacity: 0.6 }}>LinkedIn ↗</a></li>
                 <li><a href="#" style={{ color: 'inherit', textDecoration: 'none', opacity: 0.6 }}>Instagram ↗</a></li>
              </ul>
            </div>
